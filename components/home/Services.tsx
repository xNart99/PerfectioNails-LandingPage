...
const services: Service[] = [
  {
    ...
    description: "Shape, cuticle, buff, polish — 30 min",
    duration: "30 min",
    price: "35",
    category: "manicure",
  },
  {
    ...
    description: "Long-lasting gel colour on natural nails",
    duration: "45 min",
    price: "50",
    category: "manicure",
  },
  {
    ...
    description: "Natural-nail strengthener with glossy colour",
    duration: "60 min",
    price: "60",
    category: "manicure",
  },
  {
    ...
    description: "Soak, scrub, cuticle, massage, polish",
    duration: "45 min",
    price: "50",
    category: "pedicure",
  },
  {
    num: "P · 02",
    name: "Spa Pedicure",
    description: "Extended massage, mask and hot towels",
    duration: "60 min",
    price: "70",
    category: "pedicure",
  },
  {
    num: "P · 03",
    name: "Gel Pedicure",
    description: "Classic pedi + long-wear gel colour",
    duration: "60 min",
    price: "70",
    category: "pedicure",
  },
  {
    ...
    description: "Classic acrylic extensions, shape of choice",
    duration: "90 min",
    price: "75",
    category: "enhance",
  },
  {
    num: "E · 02",
    name: "Acrylic Refill",
    description: "Re-balance and re-polish within 3 weeks",
    duration: "75 min",
    price: "55",
    category: "enhance",
  },
  {
    num: "E · 03",
    name: "Nail Extensions — Tips or Forms",
    description: "Custom length, finished in gel or acrylic",
    duration: "90 min",
    price: "80",
    pricePrefix: "from ",
    category: "enhance",
  },
  {
    ...
    description: "Gentle removal of gel, acrylic or SNS",
    duration: "20 min",
    price: "15",
    category: "enhance",
  },
  {
    num: "A · 01",
    name: "French Tips / Ombré",
    description: "Classic, micro, or coloured French",
    duration: "+20 min",
    price: "10",
    pricePrefix: "+",
    category: "art",
  },
  {
    ...
    description: "Florals, lines, chrome, foils — per nail",
    duration: "varies",
    price: "5",
    pricePrefix: "from ",
    category: "art",
  ...
  {
    num: "A · 03",
    name: "Bridal & Occasion Set",
    description: "Consultation, trial options & custom design",
    duration: "2 hrs",
    price: "120",
    pricePrefix: "from ",
    category: "art",
  },
  {
    ...
    description: "Precision tidy with hot wax",
    duration: "15 min",
    price: "18",
    category: "waxing",
  },
  {
    ...
    description: "Gentle, pre- and post-care included",
    duration: "10 min",
    price: "12",
    category: "waxing",
  },
  {
    num: "W · 03",
    name: "Full Leg / Arm Wax",
    description: "Strip wax, soothing after-balm",
    duration: "45 min",
    price: "55",
    pricePrefix: "from ",
    category: "waxing",
      ...
      <div className="container">
        ...
        <div className="text-center mb-[72px]">
          ...
          <p className="max-w-[540px] mx-auto text-ink-soft">
            Pricing is a guide — final quote depends on length, design
            complexity and any removals. All prices in AUD.
          </p>
        </div>
        ...
        <div
          key={active}
          className="max-w-[960px] mx-auto border-t border-rule"
        >
          {visible.map((s) => (
            <div
              key={s.num}
            ...
            >
              <div className="font-mono text-[11px] text-ink-faint tracking-[0.1em]">
                {s.num}
              </div>
              <div>
                ...
                <div className="font-sans text-[13px] text-ink-faint mt-1">
                  {s.description}
                </div>
              </div>
        ...
        <p className="text-center mt-10 text-[13px] text-ink-faint italic font-serif">
          Prices subject to change. Please arrive 5 minutes before your
          appointment. A 24-hour cancellation notice is appreciated.
        </p>
      </div>
    </section>
  );
