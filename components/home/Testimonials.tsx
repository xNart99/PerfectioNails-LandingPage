const testimonials = [
  {
    stars: 5,
    quote:
      "Came in for a gel mani — left obsessed. The attention to shaping and cuticle work is something else. Three weeks on and still chip-free.",
    name: "Emma H.",
    location: "Camp Hill",
    initial: "E",
  },
  {
    stars: 5,
    quote:
      "Finally found my spot. The studio is so quiet and calm, the massage during pedicure is unreal, and Chi is an absolute artist. Bridal booked.",
    name: "Sophie R.",
    location: "Coorparoo",
    initial: "S",
  },
  {
    stars: 5,
    quote:
      "I'm fussy and I have very thin nails. They listened, suggested SNS over acrylic, and did the softest almond shape. Booking in again next week.",
    name: "Maria L.",
    location: "Carindale",
    initial: "M",
  },
...
export default function Testimonials() {
  return (
    <section
      id="reviews"
      className="py-[clamp(72px,10vw,140px)] bg-ink text-cream relative z-[2]"
    >
          ...
          {testimonials.map(({ stars, quote, name, location, initial }) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-[color-mix(in_oklab,oklch(0.985_0.008_85)_12%,transparent)]">
                ...
                <div>
                  <div className="font-medium text-[14px] text-cream">
                    {name}
                  </div>
